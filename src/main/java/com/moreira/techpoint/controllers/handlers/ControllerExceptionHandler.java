package com.moreira.techpoint.controllers.handlers;
...
public class ControllerExceptionHandler {
    ...
    @ExceptionHandler(InvalidTimeBankUpdateException.class)
    public ResponseEntity<CustomError> invalidTimeBankUpdate(InvalidTimeBankUpdateException e, HttpServletRequest request) {
